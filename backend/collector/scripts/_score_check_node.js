    ...
    out[code] = {
      ...
      priceRefs: {
        ...
        netCashCalc: pr.netCashCalc == null ? null : {
          ...
          termDeposit: num(pr.netCashCalc.termDeposit),
          restricted: num(pr.netCashCalc.restricted),
          noteReport: pr.netCashCalc.noteReport == null ? null : pr.netCashCalc.noteReport,
        },
